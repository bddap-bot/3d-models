...
Each plate is arranged for the 180 × 180 mm Bambu A1 mini bed and sliced at 0.20 mm with organic tree supports. The dun PLA (`#D3B7A7`) on Little's external spool uses a 65 °C textured PEI bed, 20 mm/s first-layer speeds, no fan for the first five layers, and a 5 mm outer brim.
