...
`verify.py` regenerates capacity, outlet, door-section, cage-contact, and forced-motion solids from each source, then measures the meshes with trimesh. The committed default results are in [verification.json](verification.json).

| mesh-derived result | A | B |
|---|---:|---:|
| bodies / watertight | 1 / yes | 1 / yes |
...
| build-plate contact | 12,596 mm² | 13,013.6 mm² |
| downward area steeper than 45° | 962.2 mm² | 1,115.2 mm² |
...
A PrusaSlicer 2.9.4 dry-run using the committed PETG profile, 0.2 mm layers, four perimeters, 20% gyroid infill, a 3 mm brim, and automatic supports exported both G-codes inside a 180 × 180 × 180 mm volume. A used 330.31 g with a 24 h 13 m normal estimate; B used 366.57 g with a 26 h 38 m estimate. These are comparative toolpath checks rather than Bambu Studio production profiles or physical prints.
