...
[v2/](v2) is the fable design evolved after this comparison and the hands-on below: the butt seam replaced by a 6 mm lap with a measured 0.2 mm gap, the bracket snapped onto the body, the perch 40 mm in front of the tray ([REPORT.md](v2/REPORT.md)).
...
**1. What holds the halves together, and the seam's play.** The seam is a bare plane: body_R ends at X = 0 and body_L starts there, the mating face is 917 mm² of coplanar triangles, and no feature of either half crosses X = 0. Three parts span the seam; the tray touches neither half at rest or at any shift of a half probed, so the lid and the bracket are the joint. The lid's outer headboard blocks sit 0.3 mm off the body's end faces (67.4 vs 67.7) and the bracket's window edge 0.3 mm off the groove floor (64.9 vs 65.2): body_L shifted 0.3 mm outward or toward the door intersects nothing, 0.4 mm hits the lid or the bracket; shifted 1 mm into the cage it meets nothing but a 0.002 mm³ graze on the bracket. So each half has 0.3 mm of play outward (a seam gap of up to 0.6 mm) and toward the door, and no stop at all into the cage. The lid plate (Z 117–119.4) rides between ledges whose faces are at 116.7 and 120, so the halves can also shear 0.9 mm vertically against each other. **Stands.**

| plan slab Z 118–121 | right corner, same slab: red = the 0.3 mm to the lid block | right corner, slab Z 0–3: red = the 0.3 mm to the window edge |
|---|---|---|
...
**2. What retains the bracket and tray.** The bracket's window edge sits in the body's end-wall groove, and the plate material inside the groove's footprint reaches only Z = 5.7, so the engagement is at most 5.7 mm tall. Sliding the bracket down 0.5, 2, 6 or 12 mm intersects nothing on the body halves or the lid (0 mm³ at every step); sliding it up 0.4 mm clears and 0.6 mm hits the body (window sill against the back wall's bottom edge). The grooves locate the bracket in X and let it fall. Its plate (Y from 0.3) and the body's flange (Y to −2.5) face each other across the bar plane, both faces normal to Y: the same bar can be sandwiched between them, but neither face carries load in Z, the direction the bracket is free in. The tray sits on the shelf between the bracket plate (1 mm toward the door: 539 mm³) and a ridge rising to Z = −3, 7 mm above the shelf (1 mm into the cage: 472 mm³), and lifting it hits the body (73 mm³ per half at 3 mm, 164 mm³ per half at 7 mm): it leaves only with the bracket. The lid slides outward 1, 5 or 20 mm through nothing. **Stands.** Off the cage the assembly is held by the lid's friction alone.
...
**4. Perch axis direction.** Principal axis of the same rim vertices: (1, 0, 0), 0.0° from horizontal, spanning X = −82.7 to 82.7, the bracket's full width: horizontal along the cage wall. The one attitude in which the rod is not horizontal is the print orientation, the bracket standing on its X end (REPORT.md), where it is vertical; by point 2 nothing in the model holds the loose bracket in any other attitude. **Does not stand.** The perch is horizontal in the assembly; it points down or up only as a loose bracket stands on its print end.
